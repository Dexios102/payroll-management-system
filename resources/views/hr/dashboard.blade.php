...
<!-- Statistics Cards -->
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 p-4 gap-4">
          <div class="bg-blue-500  shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-blue-600 dark:border-gray-600 text-white font-medium group">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-2 p-4  gap-4">
            <div class="bg-white shadow-lg w-100 min-h-[400px]">
