...
<body>
  <div class="container">
    <h4 class="deptLabel">Employee Records</h4>
    <button id="addBtn" class="material-symbols-outlined">
      Add<span>Add Employee</span></button>
    <div class="table-container">
      <table id="deptTable" class="hover row-border" style="width:100%">
        ...
        <tbody>
          @foreach ($emp as $item)
          <tr>
            <td><a href="#" id="checkBtn">check details</a></td>
            ...
            <td>
              <a href="#" style="padding: 1px 5px; background-color:aqua; text-decoration:none; border-radius: 5px; ">Update</a>
              <a href="#" style="padding: 1px 5px; background-color:rgb(253, 122, 61); text-decoration:none; border-radius: 5px; ">Archive</a>
            </td>
