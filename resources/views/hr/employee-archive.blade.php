...
<head>
  ...
  <link rel="stylesheet" href="css/updatedepModal.css">
          ...
          <tr>
            ...
            <td>
              <div class="action-icons">
                <a href="#" title="Update" onclick="employeeUpdate({{$item->id}})"><span class="material-symbols-outlined icons">
                      update
                    </span></a>
               <a href="#" onclick="deletemodals({{$item->id}})" class="delete" title="Archive">
...
{{-- UpdateMOdal --}}
  <div id="updateModal" class="modal">
    <div class="modal-container">
      <div class="modal-header">
        <a class="updateclose" href="#">
          <span  style="font-size: 3rem">&times;</span>
        </a>
        
        <h2 class="modal-label">Update Employee</h2>
      </div>
      <div class="modal-form">
        <form action="/employee-update" method="POST">
          @csrf
          <input type="text" name="id2" id="id2" hidden >
          <div class="wrapper">
            <div class="basic-info-container">
              <div class="form-item-modal">
                <span class="material-symbols-outlined modal-icon">
                ...
                <input type="text" name="f_name2" id="f_name2" placeholder="First Name">
              </div>
              <div class="form-item-modal">
                <span class="material-symbols-outlined modal-icon">
                  supervised_user_circle
                </span>
                <input type="text" name="m_name2" id="f_name" placeholder="Middle Name">
              </div>
              <div class="form-item-modal">
                <span class="material-symbols-outlined modal-icon">
                  signature
                </span>
                <input type="text" name="l_name2" id="f_name" placeholder="Last Name">
              </div>
              <div class="form-item-modal">
                <span class="material-symbols-outlined modal-icon">
                  supervisor_account
                </span>
                <input type="text" name="suffix2" id="suffix" placeholder="Suffix(optional)">
              </div>
              <div class="form-item-modal">
                <span class="material-symbols-outlined modal-icon">
                  phone_in_talk
                </span>
                <input type="text" name="contact2" id="contact" placeholder="Phone(optional)">
              </div>
              <div class="form-item-modal">
                <span class="material-symbols-outlined modal-icon">
                  mail
                </span>
                <input type="text" name="email2" id="email" placeholder="Email">
              </div>
              ...
              <div class="form-item-modal">
                ...
                <input type="text" name="birthplace2" placeholder="Birthplace">
              </div>
              <div class="form-item-modal">
                <span class="material-symbols-outlined modal-icon">
                  pin_drop
            ...
            <div class="dept-info-container">
              <label for="gender">Gender</label>
              <select name="gender2" id="gender2" aria-placeholder="">
                <option value="Male">Male</option>
                <option value="Female">Female</option>
              </select>
              <br>
              ...
              <label for="department">Division<span class="require">*</span></label>
              <select name="department2" id="department2" aria-placeholder="">
                @foreach ($dept as $item)
                <option value="{{$item->code}}">{{$item->code}}</option>
                @endforeach
              </select>
              <label for="position">Position<span class="require">*</span></label>
              <select name="position2" id="position2" aria-placeholder="">
                <option selected disabled> select position based on Division </option>
                @foreach ($pos as $item)
                <option value="{{$item->name}}""> ({{$item->division_info->code}}) {{$item->name}} </option>
            @endforeach
